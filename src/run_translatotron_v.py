...
from parti_pytorch import TranslatotronV, TITImageTextDataset, TITImageTextLmdbDataset
from parti_pytorch import CVColorJitter, CVDeterioration, CVGeometry
...
def parse_args():
    ...
    parser.add_argument("--teacher_model_weight", type=str, default=None, help="The path of teacher model weight.")
    parser.add_argument("--image_encoder_weight", type=str, default=None, help="The path of image encoder weight.")
    parser.add_argument("--teacher_config_path", type=str, default=None, help="The path of teacher config file.")
    parser.add_argument("--temperature", type=float, default=1.0, help="The temperature of distill.")
    ...
    parser.add_argument("--tit_smoothing", type=float, default=0.1, help="label smoothing for tit task.")
    parser.add_argument("--ocr_dropout", type=float, default=0.1, help="dropout for ocr task.")
    parser.add_argument("--tit_dropout", type=float, default=0.1, help="dropout for tit task.")
    parser.add_argument(
        "--max_train_samples",
        type=int,
        default=None,
